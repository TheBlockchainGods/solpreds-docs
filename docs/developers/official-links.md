...
All verified SOLPREDS channels and resources.
...
### Documentation
**Docs:** [https://docs.solpreds.fun](https://docs.solpreds.fun)  
...
Public API for bots and integrations.

### WebSocket
**URL:** `wss://solpreds.fun`  
...
Get free testnet SOL to play on devnet.
